...
# model config
TOKENIZER_MODEL=/mnt/nfs/home/llmjp0/llm-jp-tokenizer/models/ver2.2/code20K_en40K_ja60K.ver2.2.model
CHECKPOINT_SAVE_DIR=/mnt/nfs/home/llmjp0/checkpoints/gpt-7b-base-megatron/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}

mkdir -p ${CHECKPOINT_SAVE_DIR}

# data config
DATASET_DIR=/mnt/nfs/home/llmjp0/binarized/ver2.2/code20K_en40K_ja60K/ja_wiki
