...
CHECKPOINT_SAVE_DIR=/mnt/nfs2/data0/work/checkpoints/gpt-7b-base-megatron/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}
...
HOSTFILE_NAME=/mnt/nfs/home/llmjp0/Megatron-LM/scripts/sakura/hostfile/16node
