...
# model config
BASE_CHECKPOINT_DIR=/groups/gaf51275/llama/checkpoints/pubmed/llama-2-13b-base-extended-megatron/tp${BASE_TENSOR_PARALLEL_SIZE}-pp${BASE_PIPELINE_PARALLEL_SIZE}
TARGET_CHECKPOINT_DIR=/groups/gaf51275/llama/checkpoints/pubmed/llama-2-13b-base-extended-megatron/tp${TARGET_TENSOR_PARALLEL_SIZE}-pp${TARGET_PIPELINE_PARALLEL_SIZE}
