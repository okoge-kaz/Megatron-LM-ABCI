...
# model config
HF_CHECKPOINT_DIR=/bb/llm/gaf51275/llama/checkpoints/parallel/4%/instruction/initial/normal/hf_checkpoint
MEGATRON_CHECKPOINT_DIR=/bb/llm/gaf51275/llama/checkpoints/parallel/4%/instruction/initial/normal/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}
