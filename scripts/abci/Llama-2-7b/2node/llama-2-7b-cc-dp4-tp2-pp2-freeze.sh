...
#$ -l h_rt=00:7:00:00
#$ -j y
#$ -o outputs/llama-2-7b-base/freeze/
#$ -cwd
...
CHECKPOINT_SAVE_DIR=/bb/llm/gaf51275/llama/checkpoints/llama-2-7b-base-megatron/okazaki_lab_cc/freeze/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}
...
mpirun -np $NUM_GPUS \
  ...
  --swiglu \
  --use-flash-attn \
  --use-freeze-parameter \
  --freeze-iteration 500 \
  --freeze-transformer-layers 30 \
  --recompute-activations \
  --recompute-granularity "selective" \
  --use-mpi \
  --wandb-name ${JOB_NAME} \
  --wandb-project "Llama-2-parameter-freeze" \
